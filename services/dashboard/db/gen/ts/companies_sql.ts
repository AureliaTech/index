...
SELECT slug, name FROM companies WHERE slug = $1`;
...
INSERT INTO companies (name) VALUES ($1) RETURNING slug, name`;
...
UPDATE companies SET name = $2 WHERE slug = $1 RETURNING slug, name`;
...
DELETE FROM companies WHERE slug = $1`;
